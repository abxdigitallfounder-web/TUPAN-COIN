...
const HeroSection = () => {
  return (
    <section
      ...
      style={{ minHeight: "82dvh", paddingBottom: 24 }}
    >
      {/* ── Background video ── */}
      ...
      <div
        ...
        style={{ maxWidth: 420, paddingTop: 56, paddingBottom: 0 }}
      >
        {/* Headline */}
        <h1
      ...
      {/* ── Authority footer ── */}
      <div className="relative w-full flex flex-col items-center z-10" style={{ marginTop: 32 }}>
        <p
