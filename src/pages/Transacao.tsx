    ...
    <>
      ...
      <div className="swap-page">
        ...
        <main className="swap-main">
          <h1>Faça swap a qualquer hora, em qualquer lugar.</h1>

          <div className="swap-card">

            {/* BUY PANEL */}
            <div className="swap-panel">
              <div className="swap-panel-label">Comprar</div>
              <div className="swap-panel-row">
                ...
                />
                {buyToken && (
                  <div className="swap-token-sel" style={{ cursor:"default" }}>
                    <TokenIcon token={buyToken} />
                    <span>{buyToken.sym}</span>
                  </div>
                )}
              </div>
              <div className="swap-fiat" style={{ visibility: buyToken ? "visible" : "hidden" }}>
                {fiatLabel(buyToken, buyAmt)}
              </div>
            </div>

            {/* SWAP ARROW */}
            <div className="swap-divider">
              <button className="swap-arrow-btn" onClick={swapTokens} title="Inverter">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#acd242" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* SELL PANEL */}
            <div className="swap-panel" style={{ marginTop: "4px" }}>
              <div className="swap-panel-label">Vender</div>
              <div className="swap-panel-row">
                <input
                  className="swap-amount-input"
                  type="number" placeholder="0" min="0"
                ...
                <div className="swap-token-sel" style={{ cursor:"default" }}>
                  ...
                  <span>{sellToken.sym}</span>
                </div>
              </div>
              <div className="swap-fiat">{fiatLabel(sellToken, sellAmt)}</div>
            </div>

            {/* ACTION BUTTON */}
            <button
              className={`swap-action-btn${actionState === "ready" ? " ready" : ""}`}
              onClick={handleAction}
            >
              {actionMsg ?? actionLabel}
            </button>
          </div>

          <p className="swap-footer-text">
            Compre e venda cripto com <a href="#">tarifas zero do aplicativo</a> em mais de 17 redes,
            incluindo Ethereum, Unichain e Base.
          </p>
        </main>
